...
const renderInput = (props) => {
    ...
    return (_jsx(FieldContainerComponent, { field: field, classNames: classNames, classNameFieldName: "fieldInput", components: components, fieldKey: fieldKey, children: CustomInput ? _jsx(CustomInput, { ...props }) : _jsx(Input, { ...props }) }, fieldKey));
};
