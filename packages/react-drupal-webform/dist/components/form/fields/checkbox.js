...
export const renderCheckbox = (props) => {
    ...
    return (_jsx(FieldContainerComponent, { field: field, classNames: classNames, isLabel: false, components: components, fieldKey: fieldKey, classNamePrefix: classNamePrefix, unstyled: unstyled, children: CustomCheckbox ? (_jsx(CustomCheckbox, { ...props })) : (_jsxs(_Fragment, { children: [_jsx(Checkbox, { ...props }), title && (_jsx(CustomLabel, { classNamePrefix: classNamePrefix, wrapperElement: "label", fieldKey: fieldKey, components: components, classNames: classNames, field: field, className: styles.checkboxLabel, unstyled: unstyled }))] })) }, fieldKey));
};
