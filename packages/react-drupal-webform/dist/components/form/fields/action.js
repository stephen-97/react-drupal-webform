...
export const Action = ({ field, innerProps, className, classNamePrefix, unstyled, components, fieldKey, }) => {
    ...
    return (_jsxs("button", { type: "submit", disabled: !isValid || isSubmitting, className: actionClassNames, ...innerProps, children: [isSubmitting && (_jsx(Loader, { components: components, field: field, fieldKey: fieldKey, classNamePrefix: classNamePrefix, unstyled: unstyled })), field?.['#submit__label'] ?? 'Submit'] }));
};
