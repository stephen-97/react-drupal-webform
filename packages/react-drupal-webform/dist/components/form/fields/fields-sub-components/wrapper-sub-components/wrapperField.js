...
const WrapperField = ({ components, classNames, field, children, fieldKey, classNamePrefix, }) => {
    const ErrorFieldMessageComponent = components?.errorFieldMessage ?? ErrorFieldMessage;
    return (_jsx(_Fragment, { children: field?.['#field_prefix'] || field?.['#field_suffix'] ? (_jsxs("div", { className: styles.prefixSuffixContainer, children: [field?.['#field_prefix'] && _jsx("span", { children: field['#field_prefix'] }), _jsxs("div", { className: styles.fieldContainer, children: [children, _jsx(ErrorFieldMessageComponent, { classNamePrefix: classNamePrefix, classNames: classNames, field: field, fieldKey: fieldKey, components: components })] }), field?.['#field_suffix'] && _jsx("span", { children: field['#field_suffix'] })] })) : (_jsxs(_Fragment, { children: [children, _jsx(ErrorFieldMessageComponent, { classNamePrefix: classNamePrefix, classNames: classNames, field: field, fieldKey: fieldKey, components: components })] })) }));
};
