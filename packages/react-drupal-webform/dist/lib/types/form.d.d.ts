...
import { TDrupal_FieldType, TElementSource, TFieldWebformObj } from './components/field';
...
export type TWebformErrorMessageFieldType = Exclude<TDrupal_FieldType, 'webform_markup' | 'webform_actions' | 'fieldset'>;
export type TWebformRequiredMessageFieldType = Exclude<TDrupal_FieldType, 'webform_markup' | 'webform_actions' | 'fieldset'>;
export type TWebformLengthMessageFieldType = Exclude<TDrupal_FieldType, 'webform_markup' | 'webform_actions' | 'fieldset' | 'select' | 'managed_file'>;
