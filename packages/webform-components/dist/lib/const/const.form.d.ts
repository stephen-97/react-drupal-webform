...
export declare const defaultValueFormatObj: Required<TWebformValueFormat>;
...
export declare const components: {
    ...
    Input: (props: import("../../components/form/fields/fields-special-components/fieldObjCustom").TFieldWebformObjCustom) => import("react/jsx-runtime").JSX.Element;
    Select: (props: import("../../components/form/fields/fields-special-components/fieldObjCustom").TFieldWebformObjCustom) => import("react/jsx-runtime").JSX.Element;
    Checkboxes: (props: import("../../components/form/fields/fields-special-components/fieldObjCustom").TFieldWebformObjCustom) => import("react/jsx-runtime").JSX.Element;
